...
namespace LiveSplit.ASL
{
    public class ASLScript
    {
        ...
        public ASLSettings RunStartup(LiveSplit.UI.Components.LiveSplitState state)
        {
        ...
        public void RunShutdown(LiveSplit.UI.Components.LiveSplitState state)
        {
        ...
        private void DoExit(LiveSplit.UI.Components.LiveSplitState state)
        {
            Debug("Running exit");
            _game = null;
        ...
        private dynamic RunMethod(ASLMethod method, LiveSplit.UI.Components.LiveSplitState state)
        {
        ...
        {
            LiveSplit.UI.Components.Log.Info(String.Format("[ASL/{1}] {0}",
