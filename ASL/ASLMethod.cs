...
{{
    ...
    void print(string s)
    {{
        LiveSplit.UI.Components.Log.Info(s);
    }}
    public dynamic Execute(LiveSplit.UI.Components.LiveSplitState timer, dynamic old, dynamic current, dynamic vars, Process game, dynamic settings)
    {{
        var memory = game;
	    ...
	    return null;
                ...
                parameters.ReferencedAssemblies.Add("LiveSplit.ScriptableAutoSplit.dll");
        ...
        public dynamic Call(LiveSplit.UI.Components.LiveSplitState timer, ExpandoObject vars, ref string version, ref double refreshRate,
